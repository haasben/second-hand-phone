<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"./application/admin/view/goods\categoryList.html";i:1568702273;s:53:"D:\WWW\shop\application\admin\view\public\layout.html";i:1568702273;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3>商品分类管理</h3>
        <h5>网站文章分类添加与管理</h5>
          <a href="http://help.tp-shop.cn/Index/Help/info/cat_id/5/id/30.html" style="display: <?php echo tpCache('basic.is_manual')?'block':'none'; ?>" class="manual" target="_blank"><i class="fa fa-calendar"></i>帮助手册</a>
      </div>
    </div>
  </div>
    ...
    <div class="flexigrid" >
      <div class="mDiv">
        <div class="ftitle">
          ...
          <div class="fbutton"><a href="<?php echo U('Goods/addEditCategory'); ?>"><div title="新增分类" class="add"><span><i class="fa fa-plus"></i>新增分类</span></div></a>  </div>
          <div class="fbutton"><div class="add" title="收缩分类"><span onclick="tree_open(this);"><i class="fa fa-angle-double-up"></i>收缩分类</span></div></div>
          <div class="fbutton"><a href="http://help.tp-shop.cn/Index/Help/info/cat_id/5/id/4.html" target="_blank"><div class="add" title="帮助"><span>帮助</span></div></a></div>
          ...
          <tr data-level="<?php echo $vo[level]; ?>" parent_id_path ="<?php echo $vo['parent_id_path']; ?>" class="parent_id_<?php echo $vo['parent_id']; ?>" id="<?php echo $vo['level']; ?>_<?php echo $vo['id']; ?>">
              ...
              <td class="handle">
                <div style="text-align:left;   min-width:120px !important; max-width:inherit !important;">
                  <span style="margin-left:<?php echo ($vo[level] * 3); ?>em" class="btn"><em><?php if($vo[level] == 2): ?>|--<?php elseif($vo[level] == 3): ?>|-<?php endif; ?><i class="fa fa-cog"></i><?php echo $vo['level']; ?>设置<i class="arrow"></i></em>
                  <ul>
